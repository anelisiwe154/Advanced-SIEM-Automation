...
- Automated response workflows (e.g., isolating a device after an incident)
- Dashboard visualization for administrators

## Objectives
- Provide real-time monitoring of system and application logs
- Detect suspicious activity using rules and anomaly detection
- Enrich alerts with external threat intelligence sources
- Automate incident response actions such as device isolation
- Present alerts and incident history through a web-based dashboard